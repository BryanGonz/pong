...
simulate_game(Input* input, float dt) {
	...
	player_1_dp = player_1_dp + player_1_ddp * dt;//calculates movement
	...
	player_2_dp = player_2_dp + player_2_ddp * dt;//calculates movement
	...
	if(ball_p_x + ball_half_size > arena_half_size_x ||
	   ball_p_x - ball_half_size < -arena_half_size_x) {
		ball_dp_x *= -1;
		ball_dp_y = 0;
		ball_p_x = 0;
		ball_p_y = 0;
